...
internal_lms_data <- internal_lms_data[metric == "bmi_for_age"]
...
internal_lms_data[, test_percentile := p_bmi_for_age(q = published_quantile, male = male, age = age, source = source)]
internal_lms_data[, test_quantile   := q_bmi_for_age(p = published_percentile, male = male, age = age, source = source)]
internal_lms_data[, test_zscore     := z_bmi_for_age(q = published_quantile, male = male, age = age, source = source)]
...
d[, p := p_bmi_for_age(q = 16.19, male = male, age = age, source = "CDC")]
d[, q := q_bmi_for_age(p = 0.42, male = male, age = age, source = "CDC")]
d[, z := z_bmi_for_age(q = 15.26, male = male, age = age, source = "CDC")]
