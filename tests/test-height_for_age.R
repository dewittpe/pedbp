...
internal_lms_data <- internal_lms_data[metric == "height_for_age"]
...
internal_lms_data[, test_percentile := p_height_for_age(q = published_quantile, male = male, age = age, source = source)]
internal_lms_data[, test_quantile   := q_height_for_age(p = published_percentile, male = male, age = age, source = source)]
internal_lms_data[, test_zscore     := z_height_for_age(q = published_quantile, male = male, age = age, source = source)]
...
d[, p := p_height_for_age(q = 16.19, male = male, age = age, source = "CDC")]
d[, q := q_height_for_age(p = 0.42, male = male, age = age, source = "CDC")]
d[, z := z_height_for_age(q = 15.26, male = male, age = age, source = "CDC")]
