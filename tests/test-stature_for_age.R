...
stopifnot(all(is.na( d[d$set == "stature_for_age", "p85"])))
# test_p85 <-
#   mapply(p_stature_for_age
...
stopifnot(all.equal(test_q03, d[d$set == "stature_for_age", "p03"]))
stopifnot(all.equal(test_q05, d[d$set == "stature_for_age", "p05"]))
stopifnot(all.equal(test_q10, d[d$set == "stature_for_age", "p10"]))
stopifnot(all.equal(test_q25, d[d$set == "stature_for_age", "p25"]))
stopifnot(all.equal(test_q50, d[d$set == "stature_for_age", "p50"]))
stopifnot(all.equal(test_q75, d[d$set == "stature_for_age", "p75"]))
# stopifnot(all.equal(test_q85, d[d$set == "stature_for_age", "p85"]))
stopifnot(all.equal(test_q90, d[d$set == "stature_for_age", "p90"]))
stopifnot(all.equal(test_q95, d[d$set == "stature_for_age", "p95"]))
stopifnot(all.equal(test_q97, d[d$set == "stature_for_age", "p97"]))

# end testing q_stature_for_age }}}

# Testing z_stature_for_age {{{
test_z03 <-
  mapply(z_stature_for_age
         , q    = d[d$set == "stature_for_age", "p03"]
         , age  = d[d$set == "stature_for_age", "age"]
         , male = d[d$set == "stature_for_age", "male"]
         )
