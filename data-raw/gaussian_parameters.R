...
bp_parameters <-
  data.table::rbindlist(list(gemelli1990 = gemelli1990, nhlbi = cdc_bp, lo2013 = lo2013), idcol = "source", use.names = TRUE, fill = TRUE)

#bp_parameters[, mean_sd := data.table::fifelse(source %in% c("gemelli1990", "lo2013"), "as reported", "derived")]
