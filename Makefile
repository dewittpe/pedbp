...
DATATARGETS += $(PKG_ROOT)/data/fourth_bp_norms.rda
...
$(PKG_ROOT)/data/fourth_bp_norms.rda : data-raw/fourth_bp_norms.R data-raw/fourth_bp_boys.dat data-raw/fourth_bp_girls.dat
	R CMD BATCH --vanilla $<
...
$(PKG_ROOT)/data/bp_parameters.rda : data-raw/gaussian_parameters.R R/est_norm.R data/gemelli1990.rda  data/nhlbi_bp_norms.rda data/lo2013.rda data/fourth_bp_norms.rda
	R CMD BATCH --vanilla $<
