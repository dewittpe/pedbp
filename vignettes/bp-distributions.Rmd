...
`r  paste0(round(p_stature_for_age(q = 154, age = 13 * 12, male = 1L, source = "CDC-2000") * 100, 2), "th")  `
percentile:
...
`r  q_weight_for_stature(p = 0.5, stature = 95, male = 1)  `
...
`r  p_weight_for_stature(q = 5.8, stature = 61, male = 0)  `
weight percentile.
...
`r  q_head_circ_for_age(p = 0.5, age = 10, male = 1)  `
cm.

A head circumference of 42 cm for an 8 month old female is in the
`r  paste0(round(100*p_head_circ_for_age(q = 42, age = 8, male = 0), 5), "th") `
percentile.
