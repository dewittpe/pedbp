...
cppBPF1 <- function(sbp, dbp, age, male, known_height, height_percentile, source, type) {
    .Call('_pedbp_cppBPF1', PACKAGE = 'pedbp', sbp, dbp, age, male, known_height, height_percentile, source, type)
}
